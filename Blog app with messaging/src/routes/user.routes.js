...
import { signup , login ,logout, deleteUser, updateCredentials, updateAvatar, updatePassword, getAllUsers } from "../controllers/user.controller.js";
...
router.get("/allUsers",authorizeToken,getAllUsers)
